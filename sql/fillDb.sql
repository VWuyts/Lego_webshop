...
INSERT INTO product
    (productno, pName, price, minAge, description, isActive, category, pieces, themeID, sortID)
VALUES  (75870, "Chrevolet Corvette Z06", 17.99, 7, "Hit top speed with this buildable, minifigure-scale LEGO Speed Champions version of a true American icon—the Chevrolet Corvette Z06. The set includes interchangeable wheel trims, racing helmet, wrench and a television camera element, to fire the imagination of budding motor racing fans. Includes a Chevrolet Racing driver minifigure.", 
            1, "sets", 173, 8, 3),
...
/* Fill table product with extras which have a theme */
INSERT INTO product
    (productno, pName, price, minAge, description, isActive, category, themeID)
VALUES  (2856081, "Star Wars Darth Vader Minifigure Clock", 29.99, 7, "Feel the power of the dark side at home with the LEGO Star Wars Darth Vader Minifigure Clock. The perfect addition to every LEGO Star Wars collection, this menacing decor features a digital, lighted display and alarm clock. A great gift for any LEGO Star Wars fan.", 
            1, "extras", 9),
        (2856080, "Star Wars Stormtrooper Minifigure Clock", 29.99, 6, "Celebrate the Star Wars saga around the clock with the LEGO Star Wars Stormtrooper Minifigure Clock. The perfect addition to every LEGO Star Wars collection, this menacing decor features a digital, lighted display and alarm clock. A great gift for any LEGO Star Wars fan.", 
            1, "extras", 9),
        (853470, "Star Wars R2-D2 Keyring", 4.99, 6, "Turn every trip into an exciting adventure with this LEGO Star Wars R2-D2 Key Chain. Attach it to your keys or backpack using the durable key ring and chain and let this pint-size Astromech Droid bring a smile to your face wherever you go.", 
            1, "extras", 9)
;

/* Fill table product with extras which have a number of pieces*/
INSERT INTO product
    (productno, pName, price, minAge, description, isActive, category, pieces)
VALUES  (40174, "Lego Iconic Chess Set", 59.99, 9, "Use classic LEGO bricks to build your own chess board and then build all the playing pieces too. This set is ideal to take and play wherever you like, as the pieces store conveniently inside the board. It can also be used to play checkers.", 
            1, "extras", 1450),
        (40161, "What An I?", 39.99, 7, "Play LEGO Iconic What Am I? and ask yes/no questions to guess your opponent's minifigure or small build—there are 16 buildable and removable minifigures included with the game, or you can use your own to add to the fun! The game also comes with building instructions and rules for playing, and the handy packaging can be used to store the game between uses.", 
            1, "extras", 536),
        (40155, "Piggy Coin Bank", 12.99, 7, "Build the LEGO Iconic Piggy Coin Bank and store your money inside. Drop your coins through the slot and turn the red piggy's eyes and posable ears for a variety of cute expressions.", 
            1, "extras", 148),
        (40154, "Lego Iconic Pencil Pot", 12.99, 7, "Build the perfect home for all your stationery with the LEGO Iconic Pencil Pot! Follow the included building instructions to construct this colorful house and then store your pencils, pens, rulers, erasers and more in its 3 rooms. Includes 2 minifigures.", 
            1, "extras", 174),
